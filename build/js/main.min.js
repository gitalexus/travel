...
var _initSliders = require("./modules/init/initSliders");
var _burger = require("./modules/init/burger");
...
},{"./modules/form-validate/form":3,"./modules/init/burger":9,"./modules/init/initSliders":10,"./utils/ios-vh-fix":12}],2:[function(require,module,exports){
"use strict";
...
var heroSliderSelector = '[data-swiper="hero"]';
var toursSliderSelector = '[data-swiper="tours"]';
var trainingSliderSelector = '[data-swiper="training"]';
var reviewsSliderSelector = '[data-swiper="reviews"]';
var advantagesSliderSelector = '[data-swiper="advantages"]';
var gallerySliderSelector = '[data-swiper="gallery"]';
...
function initSlider(sliderSelector, sliderOptions) {
  ...
  if (slider) {
    return new _swiper.default(slider, sliderOptions);
  }
  return null;
}
...
function initSliders() {
  ...
  var slides = document.querySelectorAll('[data-slide="slide"]');
...
},{"../../vendor/swiper.js":13}],11:[function(require,module,exports){
"use strict";
